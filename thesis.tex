...
\includepdf{MOGI_DM_K9QU7H_24o-1.pdf}
...
% Előszó [Preface]
\include{mychapters/00_preface}


% Jelölések jegyzéke [Table of Symbols]
\include{mychapters/00_symbols}
...
% ----------------------------------------------------------
% my chapters
\include{mychapters/01_bevezetes}
\include{mychapters/02_irodalom-models-mppi}
\include{mychapters/03_irodalom-ros2-nav2}
\include{mychapters/04_planning}
\include{mychapters/05_work}
\include{mychapters/06_plots}
